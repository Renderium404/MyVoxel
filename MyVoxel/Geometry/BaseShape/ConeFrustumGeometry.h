#ifndef MYVOXEL_GEOMETRY_CONEFRUSTUMGEOMETRY_H
#define MYVOXEL_GEOMETRY_CONEFRUSTUMGEOMETRY_H
...
class ConeFrustumGeometry : public ShapeGeometry
{
public:
    // 使用底面半径、顶面半径和完整高度创建标准圆锥台，两个半径允许其中一个为零。
    ConeFrustumGeometry(double bottomRadius, double topRadius, double height);
...
protected:
    ...
    ~ConeFrustumGeometry() override = default;
...
#endif // MYVOXEL_GEOMETRY_CONEFRUSTUMGEOMETRY_H