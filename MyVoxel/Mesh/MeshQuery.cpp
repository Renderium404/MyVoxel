...
MeshQuery::MeshQuery(const Mesh& mesh)
    ...
    , m_valid(false)
{
    MYVOXEL_ASSERT_MESSAGE(mesh.isGeometryValid(), "MeshQuery requires a geometrically valid Mesh.");
    MYVOXEL_ASSERT_MESSAGE(!mesh.isEmpty(), "MeshQuery requires a non-empty Mesh.");
